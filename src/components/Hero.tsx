  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          {/* Decorative graphic / placeholder for portrait */}
          <div className="relative w-full aspect-[4/5] rounded-3xl glass-card overflow-hidden border border-border">
            <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent" />
            <div className="absolute inset-0 flex items-center justify-center text-4xl font-heading font-bold text-gray-500/20">
              DK.
            </div>
          </div>
        </motion.div>
